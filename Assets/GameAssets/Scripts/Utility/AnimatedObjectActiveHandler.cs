...
namespace KMK
{
    ...
    public class AnimatedObjectActiveHandler : MonoBehaviour
    {
        ...
        {
            EnableObject(TweenType.Scale, transitionTime, curves.Overshoot);
        }
        ...
        public void EnableObject(TweenType type, float transitionTime, AnimationCurve curve)
        {
            ...
            {
                StopCoroutine(animationRoutines);
            }

            animationRoutines = Animate(new AnimationParameters() { type = type, time = transitionTime, curve = curve, active = true });
            StartCoroutine(animationRoutines);
        ...
        {
            DisableObject(TweenType.Scale, transitionTime, curves.SmoothIn);
        }
        ...
        public void DisableObject(TweenType type, float transitionTime, AnimationCurve curve)
        {
            ...
            animationRoutines = Animate(new AnimationParameters() { type = type, time = transitionTime, curve = curve, active = false });
